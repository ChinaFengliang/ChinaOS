...
)
{
    ...
    {               
        ...
        if (i == _FS_SHARE)             /* No space to register (int err) */
            return 0;
        Files[i].fs = dj->fs;
        Files[i].clu = dj->sclust;
        Files[i].idx = dj->index;
...
** Descriptions:            Decrement file open counter
** Input parameters:        i : Semaphore index
** Output parameters:       
** Returned value:          
**--------------------------------------------------------------------------------------------------------------------
** Created by:              Fengliang
** Created Date:            2011-5-16  22:30:55
** Test recorde:            
**--------------------------------------------------------------------------------------------------------------------
** Modified by:
** Modified date:
...
** Descriptions:            Clear lock entries of the volume
** Input parameters:        
** Output parameters:       
...
**--------------------------------------------------------------------------------------------------------------------
** Created by:              Fengliang
** Created Date:            2011-5-16  22:32:13
** Test recorde:            
**--------------------------------------------------------------------------------------------------------------------
** Modified by:
** Modified date:
...
/*********************************************************************************************************************
** Function name:           f_unmount
** Descriptions:            Unmount a Logical Drive
** Input parameters:        vol : Logical drive number.
** Output parameters:       
** Returned value:          ==OS_OK : 操作成功
**                          !=OS_OK : 操作失败(包含出错信息)
**--------------------------------------------------------------------------------------------------------------------
** Created by:              Fengliang
** Created Date:            2011-5-16  22:54:4
** Test recorde:            
**--------------------------------------------------------------------------------------------------------------------
** Modified by:
** Modified date:
** Test recorde: 
*********************************************************************************************************************/
FRESULT f_unmount(BYTE vol)
{
    return f_mount(vol, NULL);
}

/*********************************************************************************************************************
** Function name:           f_open
** Descriptions:            Open or Create a File
** Input parameters:        fp : Pointer to the blank file object.
...
)
{
    ...
    if (fmt == FS_FAT32) {
        ...
        mem_cpy(tbl+BS_VolLab32, "ChinaOS    " "FAT32   ", 19); /* Volume label, FAT signature */
    } else {
